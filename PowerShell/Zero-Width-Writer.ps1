#Plaintext file containing the content that will be converted to zero-width. This file should be placed within the same folder as the script.
...
#Add double quotation marks on the start and end of the string.  These are placed in the script for easier identification.
