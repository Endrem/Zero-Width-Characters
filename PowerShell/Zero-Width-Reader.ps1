#ZeroWidth file containing the content that will be converted to plaintext. This file should be placed within the same folder as the script.
...
#Trim the double quotation marks on the start and end of the string.  These were placed from the Zero-Width-Writer script for easier identification.
